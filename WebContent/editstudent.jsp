		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu"href="#"><i class="fa fa-laptop fa-3x"></i>Học sinh<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="active-menu" href="student.jsp">Quản lý học sinh</a> <a href="addstudent.jsp">Thêm
									học sinh</a></li>
						</ul></li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Nhập thông tin học viên để sữa
							</div>
							<div class="panel-body">
								<div class="col-md-12">
									<form action="StudentServlet" method="post">
										<div class="form-group">
											<label>Mã học sinh</label> <input class="form-control"
												name="id" readonly="readonly" value='<%=s.getIDStudent()%>'>
											<label>Tên học sinh</label> <input class="form-control"
												name="name" value='<%=s.getNameStudent()%>'>
											<label>Tài khoản</label> <input class="form-control"
												name="user" value='<%=s.getUsername()%>'>
											<label>Mật khảu</label> <input class="form-control"
												name="pass" value='<%=s.getPassword()%>'>
											<label>Tuổi</label> <input class="form-control"
												name="age" value='<%=s.getAge()%>'>
											<label>Địa chỉ</label> <input class="form-control"
												name="adress" value='<%=s.getAdress()%>'>
