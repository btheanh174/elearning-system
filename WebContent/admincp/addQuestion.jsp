...
<body>
<%
		ExamManager a = new ExamManager();
		a.openConnection();
		List<Exam> lstExam = a.getList();
	%>
    <div id="wrapper">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
							<li>
                            	...
                            	<a class="active-menu" href="#">Thêm câu hỏi</a>
                            </li>
						</ul>
                    </li>	                         
            </div>
             ...
             <!-- /. PAGE INNER  -->
              <div class="panel panel-default">
                        <div class="panel-heading">
                            Nhập thông tin học sinh để thêm
                        </div>
                             ...
                             <div class="col-md-12">
                             	<form action="QuestionServlet" method="post">
                                    <div class="form-group">
                                        <label>Đề</label>
                                        <select class="form-control" name="codeExam">
                                                <%
                                                for(Exam ex: lstExam)
                                                {
                                        ...
                                        <input class="form-control" name="question" />
                                         <label>Câu A</label>
                                        <input class="form-control" name="qA"/>
                                        <label>Câu B</label>
                                        <input class="form-control" name="qB" />
                                        <label>Câu C</label>
                                        <input class="form-control" name="qC" />
                                        <label>Câu D</label>
                                        <input class="form-control" name="qD"/>
                                        ...
                                        <button type="submit" class="btn btn-default" value="Add">Thêm câu hỏi</button>
