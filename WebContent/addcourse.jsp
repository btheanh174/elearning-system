		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="#"><i class="fa fa-laptop fa-3x"></i>khóa học<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="student.jsp">Quản lý học sinh</a> <a href="addstudent.jsp">Thêm
									học sinh</a></li>
						</ul></li>
					<li><a class="active-menu" href="#"><i class="fa fa-table fa-3x"></i> Khóa học<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="course.jsp">Quản lý khóa học</a> <a class="active-menu" href="addcourse.jsp">Thêm
									khóa học</a></li>
						</ul></li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>Thêm khóa học</h2>
						<h5>Nhập thông tin khóa học để thêm</h5>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Nhập thông tin khóa học để thêm
							</div>
									...
									<form action="CourseServlet" method="post">
										<div class="form-group">
											...
											<label>Tên khóa học</label> <input class="form-control"
												name="name" >
											<label>Nội dung khóa học</label> <input class="form-control"
												name="content" >
