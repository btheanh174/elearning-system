											...
											<tbody>
												<%
													...
													for (int i = 0; i < lstCourse.size(); i++) {
														...
														out.write("\t<tr>\n");
														out.write("\t\t<td>" + c.getIdCourse() + "</td>\n");
														out.write("\t\t<td>" + c.getNameCourse() + "</td>\n");
														out.write("\t\t<td>" + c.getContent() + "</td>\n");
														out.write("\t\t<td><input type='checkbox' name='" + i + "'></td>\n");
														out.write("\t\t<td><a href='editcourse.jsp?ID=" + c.getIdCourse()
																+ "' class='btn btn-info btn-sm'><span class='glyphicon glyphicon-edit'></span></a>");
														out.write("<input type='hidden' name='id' value='" + c.getIdCourse() + "'>\n");
														out.write("\t</tr>\n");
													}
												%>
												<tr>
