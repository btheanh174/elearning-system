			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="#"><i class="fa fa-qrcode fa-3x"></i> Đề thi<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="exam.jsp">Quản lý đề thi</a> <a class="active-menu" 
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>Thêm đề thi</h2>
						<h5>Nhập thông tin đề thi để thêm</h5>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Nhập thông tin đề thi để thêm</div>
									...
									<form action="ExamServlet" method="post">
										<div class="form-group">
											<label>Khóa học</label> <select class="form-control"
												name="codeCourse">
												<%
													for (Course co : lstCourse) {
														out.write("<option value="+co.getIdCourse()+">" + co.getNameCourse() + "</option>");
													}
												%>
