				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Nhập thông tin học viên để sữa</div>
							<div class="panel-body">
								<div class="col-md-12">
									<form action="ExamServlet" method="post">
										<div class="form-group">
											<label>Mã đề</label> <input class="form-control" name="id"
												readonly="readonly" value='<%=e.getCodeExam()%>'> 
												
												<label>Khóa
												học</label> <select class="form-control" name="codeCourse">
												<%
													for (Course es : lstCourse) {
														if (e.getCodeCourse() == es.getIdCourse()) {
															out.write("<option selected='selected' value="+es.getIdCourse()+">" + es.getNameCourse() + "</option>");
														} else
															out.write("<option value="+es.getIdCourse()+">" + es.getNameCourse() + "</option>");

													}
												%>
												</select><label>Tên đề</label> <input class="form-control"
												name="exam" value='<%=e.getNameExam()%>'>
										</div>
