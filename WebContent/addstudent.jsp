				...
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="#"><i class="fa fa-laptop fa-3x"></i>Học sinh<span
						...
						<ul class="nav nav-second-level">
							<li><a href="student.jsp">Quản lý học sinh</a> <a class="active-menu" href="addstudent.jsp">Thêm
									học sinh</a></li>
						</ul></li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>Thêm học sinh</h2>
						<h5>Nhập thông tin học sinh để thêm</h5>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Nhập thông tin học sinh để thêm
							</div>
